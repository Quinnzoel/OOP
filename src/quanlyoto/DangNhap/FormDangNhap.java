...
import quanlyoto.Database.Query.Select;
import quanlyoto.QuanLyKho.FormKho;
...
public class FormDangNhap extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        BasicFunction login = new BasicFunction();
        FormKho fk = new FormKho();
        try {
            if(login.DangNhap(username, password)==0)
            {
                fk.setVisible(true);
                dispose();
            }
//            else if(login.DangNhap(username, password)==1)
//            {
//                fk.setVisible(true);
//                dispose();
//            }
            else {
                jLabel3.setText("Sai tài khoản hoặc mật khẩu");
